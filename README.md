...
- **VRAM considerations**
  ...
  - Because of this, I recommend renting a cloud GPU to run DA3, then copying the necessary file
    (`data/input/custom/<SCENE_NAME>/transforms.json`) locally (or to a smaller GPU instance) to complete training.
